...
enum EmployeeInfo {
    ...
    static let names = ["Tran", "Lenore", "Bud", "Fredda", "Katrice",
                        ...
                        "Willard", "Mireille", "Richi","Elise", "Trang",
                        "Ty", "Pierre", "Floyd", "Savanna", "Arvilla",
                        "Whitney", "Denver", "Norbert", "Meghan", "Tandra",
                        "Jenise", "Brent", "Elenor", "Sha", "Jessie", "Aaron",
                        "Arnold", "Anna", "Shai", "Aaron", "Sara"]
    
    
    static let surnames = [ "Farrah", "Laviolette", "Heal", "Sechrest", "Roots",
                            ...
                            "Moor", "Vai", "Clinton", "Goldman", "Bronson"]
}
